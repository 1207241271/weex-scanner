...
public final class CameraManager {
  ...
  private volatile int mCustomOffset = 0;
  ...
  public synchronized void setCustomOffset(int offset) {
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      int topOffset = (screenResolution.y - height) / 2 - mCustomOffset;
      int tmpOffset = mCustomOffset;
      while (tmpOffset > 1) {
        if (topOffset > 0) {
          break;
        }
        tmpOffset /= 2;
        topOffset = (screenResolution.y - height) - tmpOffset;
      }
      mCustomOffset = tmpOffset;
